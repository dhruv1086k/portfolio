...
export default function Profile() {
  return (
    <div
      className="group/profile flex h-52 w-52 flex-col items-center justify-center rounded-3xl bg-cyan-200 p-4 shadow-sm transition-shadow duration-300 hover:shadow-black/25 dark:bg-zinc-800">
      <img
        alt=""
      ...
      <div
        className="mt-2 flex w-full flex-row justify-evenly rounded-3xl bg-background/70 p-2 text-foreground dark:bg-background/25">
        <a
